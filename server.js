...
options.log = require('./node_modules/http2/test/util').createLogger('server');

// We cache one file to be able to do simple performance tests without waiting for the disk
var cachedFile = fs.readFileSync(path.join(__dirname, './sw.js'));
var cachedUrl = '/sw.js';
...
server.listen(process.env.HTTP2_PORT || 9090);

console.log("server started! https://localhost:"+(process.env.HTTP2_PORT || 9090)+"/index.html");